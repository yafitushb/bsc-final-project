...
* 👁️ **[View Presentation Online (PDF)](./docs/Presentation_Authentication_Security.pdf)** — *Fast browser preview (static slides)*
* 🎬 **[Download Interactive Presentation (PPTX)](./docs/Presentation_Authentication_Security.pptx)** — *Full version with embedded demo videos (65MB)*
